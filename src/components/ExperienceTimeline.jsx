  ...
  return (
    <Timeline className="flex flex-col gap-4">
      <Timeline.Item>
        <Timeline.Point />
        <Timeline.Content>
          <Timeline.Time>Septiembre 2023 - Actualidad</Timeline.Time>
      ...
      <Timeline.Item>
        <Timeline.Point />
        <Timeline.Content>
            <Timeline.Time>Julio 2023 - Septiembre 2023 | Julio 2022 - Septiembre 2022 | Julio 2021 - Septiembre 2021</Timeline.Time>
      ...
      <Timeline.Item>
        <Timeline.Point />
        <Timeline.Content>
          <Timeline.Time>Marzo 2019 - Junio 2019</Timeline.Time>
